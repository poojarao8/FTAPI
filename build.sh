...
function config_fission {
    ...
    export PETSC_DIR=/home/dealvf/libs/petsc-3.1-p8_ompi-1.4.4_gcc-4.6.1_fission
    export PETSC_INCLUDE="-I${PETSC_DIR}/include"
    ...
    export CONF="--with-openmpi=/apps/local/openmpi/1.4.3/gcc-4.6.1/opt --with-petsc=${PETSC_DIR} --with-devel ${CONF}"
    PMAKE="-j2"
}
...
function config_icestorm {
    ...
    export PETSC_DIR=/home/dealvf/libs/petsc-3.1-p8_ompi-1.4.3_gcc-4.6.0_icestorm
    export PETSC_INCLUDE="-I${PETSC_DIR}/include"
    ...
    export CONF="--with-openmpi=/usr/local/openmpi/openmpi-1.4.3/gcc-4.6.0 --with-petsc=${PETSC_DIR} --with-devel ${CONF}"
    PMAKE="-j2"
}
