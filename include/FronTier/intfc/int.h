...
#ifdef IMESH
#include <FronTier/intfc/iTaps.h>
#endif /*def IMESH */
...
struct _CURVE
{
	...
	int  sindx, eindx;
	int user_type;		// Set via api, and returned to user when
				// crossings are queried.
};
...
struct _HYPER_SURF
{
	...
	//int (*velocity_func)(POINTER, double*, double*);
	//void* velocity_params;
	int surf_type;
};
...
enum {
        ...
        MAX_CRX_FILL = 100  /* Maximum number of missing crxings to be filled */
};
