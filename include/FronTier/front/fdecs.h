...
struct _Front {
	...
	boolean print_sdl_file;
        ...
        double subgrid_time;
        int restart_step;
        boolean regrid_restart;
        boolean repartition;
        int last_restart_step;
        boolean restart_small_dt;
        boolean start_small_dt;
        boolean end_small_dt;
        boolean use_fast_merge_algo;
        boolean turbulence_model;
        boolean is_bad_tri;
        int   gmax[MAXD];    /* Number of global grid blocks             */
        int   gmax_regrid[MAXD];
        int   gmax_new_pp_grid[MAXD];
